import { apiHandler, batteryDetectionResRepo } from "@/helpers/api";
...
async function allhandler(req: any, res: any) {
    ...
    try {
        ...
        const response = await batteryDetectionResRepo.getResponse(data);
        ...
        loggerError.error("Cant fetch Battery Detection Response", error);
