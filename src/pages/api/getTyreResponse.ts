import { apiHandler, tyreDetectionResRepo } from "@/helpers/api";
...
async function allhandler(req: any, res: any) {
    ...
    try {
        ...
        const response = await tyreDetectionResRepo.getResponse(data);
        ...
        loggerError.error("Cant fetch Tyre Detection Response", error);
