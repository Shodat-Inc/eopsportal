...
import { inviteValidation } from "../../../validateSchema";
...
async function handler(req: any, res: any) {
    try {
        ...
        const validation = inviteValidation(updateData);
        if (validation.error) {
        ...
        const updatedRole: any = await EnterpriseUsersRepo.inviteEnterpriseUser(updateData, reqAuth);
