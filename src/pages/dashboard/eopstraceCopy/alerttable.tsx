                    ...
                    <tbody>
                        {
                            data.map((items: any, index: any) => (
                                <tr key={index}>
                                    ...
                                    <td>
                                        {
                                            items.batteryUtilizationValue ?
                                                <>
                                                    (Battery Usage)
                                                    {items.condition === "greather than" ? " > " : " < "}
                                                    {items.batteryUtilizationValue}
                                                </>
                                                :
                                                <>
                                    ...
                                    <td>
                                        <Link
                                            className="mr-5"
                                            href={{
                                                pathname: "/dashboard/eopstrace/editalerts",
                                                query: {
...

                        {
                            data.map((items: any, index: any) => (
                                <tr key={index}>
                                    <td>{items.alertName}</td>
                                    <td>
                                        {items.thresholdMeasure === "less than" ? "<" : ">"} {items.thresholdMeasure} {items.thresholdValue} %
                                    </td>
                                    <td>{items.DateCreated}</td>
