...
export default function ProductionView() {
    ...
    const [newPlot, setNewPlot] = useState(plots);

    const handleRange = (e: any) => {
        setPlots(plots)
        setValue(e.target.value);
        let arr = plots;
        arr = plots.filter((item: any) => {
            return item.tvalue >= e.target.value
        })
        setNewPlot(arr)
                                        ...
                                        <div>
                                            {
                                                parentAsset.objectID && parentAsset.model === "Tire Wear Detection" && parentAsset.subObject === "Tire" ?
                                                    ...
                                                    <div className="relative mt-0 w-full flex flex-wrap justify-start items-start">
                                                        <div className="relative w-[45%]">
                                                            <div className="bg-gray-960 h-[400px] w-[460px] rounded roundex-xl relative overflow-hidden">
                                                                <Image
                                                                ...
                                                                <div className="z-50 relative">
                                                                    <svg className="stroke-2 stroke-red-500" fill="transparent" width={460} height={400}>
                                                                        {
                                                                            newPlot && newPlot.length > 0 ?
                                                                                newPlot.map((item: any, index: any) => (
                                                                                    <rect
                                                                                        x={item.x}
                                                                                        y={item.y}
                                                                                        width="100"
                                                        ...
                                                        <div className="relative pl-10 w-[55%]">
                                                            <p className="mb-2 p-0 text-black text-xl font-semibold hidden">My Objects</p>
                                                            <Image
                                                                src="/img/Crop.png"
                                                                alt="Result"
                                                                height={87}
                                                            ...
                                                            />
                                                            <p className="mb-4 p-0 text-black text-normal font-normal hidden">To create an object, hover and select the region in the image</p>
