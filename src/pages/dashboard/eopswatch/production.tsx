                ...
                <div className="w-[246px] overflow-hidden rounded rounded-xl mr-4 mb-4 relative">
                    <div className="h-[200px] w-[246px] overflow-hidden rounded rounded-xl relative">
                        <div className="flex justify-start items-center absolute top-0 right-0">
                            ...
                            <button
                                onClick={() => imageModalFunction('/img/CrackDetection/TPC71810-01-012/Production/WallProd1.png')}
                        ...
                        <Image
                            src="/img/CrackDetection/TPC71810-01-012/Production/WallProd1.png"
                            alt="Crack Detection"
                            height={200}
                            width={246}
                ...
                <div className="w-[246px] overflow-hidden rounded rounded-xl mr-4 mb-4 relative">
                    <div className="h-[200px] w-[246px] overflow-hidden rounded rounded-xl relative">
                        <div className="flex justify-start items-center absolute top-0 right-0">
                            ...
                            <button
                                onClick={() => imageModalFunction('/img/CrackDetection/TPC71810-01-012/Production/WallProd2Result.png')}
                                className="text-sm font-semibold h-[32px] px-1 rounded rounded-lg inline-flex justify-center items-center bg-[#333333]">
                                <Image
                                    src="/img/external-link-white.svg"
                                    alt="Test Icon"
                        ...
                        <Image
                            src="/img/CrackDetection/TPC71810-01-012/Production/WallProd2Result.png"
                            alt="Crack Detection"
                            height={200}
                            width={246}
                            className="object-cover h-full w-full"
