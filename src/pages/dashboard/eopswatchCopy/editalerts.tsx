        ...
        axios.get("/api/getParentAlerts").then((response) => {
            if (response.data) {
                ...
                setFormData({
                    ...
                    thresholdValue: filtered[0].threshold ? filtered[0].threshold : "0",
                    tireWare: filtered[0].tireware,
                })
            }
        });
    };
                                        ...
                                        <div className=" mb-1 ml-28 flex justify-start items-center">
                                            <div className={`${styles.form__wrap} w-[200px] pt-[15px] mr-10`}>
                                                <select
                                                    ...
                                                    id="thresholdMeasure"
                                                    className={`border border-black h-[50px] relative rounded rounded-xl w-[200px] px-2 ${formData.tireWare ? 'border-gray-951 bg-gray-957' : 'border-black bg-white'}`}
                                                    value={formData.thresholdMeasure}
                                                    onChange={(e) => handleInput(e)}
                                                    // disabled={disableCondition ? true : false}
                                                    disabled={formData.tireWare ? true : false}
                                                >
                                            ...
                                            <div className={`${styles.form__wrap} w-[300px]`}>
                                                <div className={`relative ${styles.form__group} font-OpenSans`}>
                                                    <input
                                                        ...
                                                        id="thresholdValue"
                                                        name="thresholdValue"
                                                        className={`${styles.form__field} border border-black w-[250px] ${formData.tireWare ? '!border-gray-951 !bg-gray-957' : 'border-black bg-white'}`}
                                        ...
                                        <div className=" mb-1 ml-28 flex justify-start items-center">
                                            <div className={`${styles.form__wrap} w-[540px]`}>
                                                ...
                                                <select
                                                    name="tireWare"
                                                    id="tireWare"
                                                    className={`mt-1 border h-[50px] relative rounded rounded-xl w-[540px] px-2 ${formData.thresholdMeasure ? 'border-gray-951 bg-gray-957' : 'border-black bg-white'}`}
                                                ...
                                                >
                                                    <option value="">-Select-</option>
                                                    {
                                                        tirewareOptions.map((item: any, index: any) => (
                                                            <option selected={item === data && data.tireware} key={index} value={item}>{item}</option>
                                                        ))
                                                    }
                                                </select>
                                            </div>
