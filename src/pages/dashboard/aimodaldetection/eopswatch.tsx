        ...
        <div className="flex w-full h-full mt-1">
            ...
            <div className="w-[80%] px-8 py-5 rounded-r-xl rounded-bl-xl border border-[#E3E3E3] border-l-2 border-t-0 border-b-2 border-r-0 bg-white min-h-[500px]">
                <div className="flex justify-between items-start mb-8">
                    <div className="text-md font-semibold">Model Details1</div>
                    {
                ...
                <div className="mb-8">
                    <button
                        className="h-[44px] px-2 py-1 px-3 flex justify-center items-center bg-yellow-951 border border-yellow-951 text-md text-black rounded rounded-xl"
                    >
                    ...
                    {data.activePlan == true ?
                        <>
                            <div className="flex justify-start items-center">
                                <button
                                    className="h-[44px] px-2 py-1 flex justify-center items-center bg-yellow-951 border border-yellow-951 text-sm text-black rounded rounded-xl"
                                >
