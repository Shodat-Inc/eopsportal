...
export default function AiModelDetection() {
    ...
    return (
        <div className="font-OpenSans w-full">
            ...
            {/* Search Filter */}
            <div className="border border-yellow-951 min-h-[120px] bg-white rounded-lg w-full p-4 flex justify-start items-center mb-6 flex-wrap flex-row">
                <div className={`flex ${showObject ? 'justify-between' : 'justify-start'} items-center w-full`}>
                    ...
                    <div className="flex justify-start items-center ml-4">
                        ...
                        <button
                            ...
                            className="text-white bg-[#404040] border border-[#666666] rounded-md flex justify-center items-center h-[30px] px-3 text-sm">
                            Reset
                        </button>
                    </div>
                </div>
                ...
                <div className="w-full mt-3">
                    {showObjLvlButton &&
                        <div className="w-full flex justify-end">
                            <button
                                className="flex justify-center items-center rounded-lg h-[35px] px-3  py-3 bg-[#404040] border border-[#404040] text-white text-sm mb-7"
