                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-start w-full flex-wrap flex-row">
                                        ...
                                        <div className="relative flex">
                                            <div
                                                className="flex justify-center items-center bg-white text-black rounded-t-md w-[110px] h-[40px] font-semibold cursor-pointer"
                                                onClick={clearAll}
                                            >
                                                <Image
                                                    src="/img/close.svg"
                                        ...
                                        {/* <div className="flex justify-between items-center mb-5">
                                            ...
                                            <div className="relative w-[50%]">
                                                <input
                                                    ...
                                                    name="modeltype"
                                                    className="rounded-lg border border-gray-954 h-[44px] pl-5 pr-5 w-[320px] focus:outline-none focus:border-yellow-951"
                                                    onChange={(e) => (modeltype.current = e.target.value)}
                                                />
                                            </div>
                                        </div>
                                        <div className="flex justify-between items-center mb-5">
                                            ...
                                            <div className="relative w-[50%]">
                                                <input
                                                    ...
                                                    name="mfdDate"
                                                    className="rounded-lg border border-gray-954 h-[44px] pl-5 pr-5 w-[320px] focus:outline-none focus:border-yellow-951"
                                                    onChange={(e) => (mfdDate.current = e.target.value)}
                                                />
                                            </div>
                                        </div>
                                        <div className="flex justify-between items-center mb-5">
                                            <div className="relative w-[50%]">
                                                <input
                                                    ...
                                                    name="capacityInCC"
                                                    className="rounded-lg border border-gray-954 h-[44px] pl-5 pr-5 w-[320px] focus:outline-none focus:border-yellow-951"
                                                    onChange={(e) => (capacityInCC.current = e.target.value)}
                                                />
                                            </div>
                                            <div className="relative w-[50%]">
                                                <input
                                                    ...
                                                    name="cylinders"
                                                    className="rounded-lg border border-gray-954 h-[44px] pl-5 pr-5 w-[320px] focus:outline-none focus:border-yellow-951"
                                                    onChange={(e) => (cylinders.current = e.target.value)}
                                                />
                                            </div>
                                        </div> */}
