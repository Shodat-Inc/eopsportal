...
async function getObjectBySerialId(params: any) {
    try {
        ...
        if (!Object.keys(params).length) {
            return sendResponseData(false, "Please provide specific data in params you are looking for", {})
        }
        ...
        loggerError.error("Error in Model Repo", error)
        return sendResponseData(false, "Error in Fetching Object By SerialID", error)
    }
}
...
async function getClassObjectBySerialId(params: any) {
    try {
        ...
        loggerError.error("Error in Model Repo", error)
        return sendResponseData(false, "Error in Fetching Class Object By SerialID", error)
    }
}
...
async function getSubClassObjectBySerialId(params: any) {
    try {
        ...
        loggerError.error("Error in Model Repo", error)
        return sendResponseData(false, "Error in Fetching SubClass Object By SerialID", error)
    }
}