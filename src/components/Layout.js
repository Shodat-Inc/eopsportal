...
export default function Layout({ children }) {
  ...
  return (
    <>
      ...
      <main
        className={`h-screen ${splitPathName.includes("eopswatch") || splitPathName.includes("assetmanagement") || splitPathName.includes("eopsprosense") || splitPathName.includes("eopstrace") || splitPathName.includes("eopsinsight") || splitPathName.includes("myaccount") || splitPathName.includes("aimodaldetection") ? 'bg-gray-966' : 'bg-white'} pt-24 transition-all duration-[400ms] ${showNav && !isMobile ? "pl-64" : ""
          }`}
      >
