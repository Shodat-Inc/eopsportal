...
export default function ActiveModal(props: any) {
    const closeModal = () => {
        console.log({
            item: "item"
        })
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="relative pt-2 pb-8 flex-auto">
                            <div className="flex justify-start items-center flex-wrap flex-col">
                                <p className="flex justify-center items-center text-lg">Are you sure want to <span className="text-[#57954D] mx-1 font-semibold">Active</span> this user?</p>
